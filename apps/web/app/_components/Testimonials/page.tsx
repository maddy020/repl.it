        ...
        {[...new Array(2)].fill(0).map((_, index) => (
          <React.Fragment key={index}>
            {props.testimonials.map(({ text, imageSrc, name, username },i) => (
              <div className="rounded-2xl p-4 bg-white shadow-sm" key={i}>
                <div>{text}</div>
    ...
    <section className="bg-white" id="testimonials">
      <div className="flex flex-col px-10">
        <div className="max-w-[540px] mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight bg-gradient-to-b from-black to-black/70 text-transparent bg-clip-text text-center leading-none pt-1">
            What our users say
          </h2>
        ...
        <div className="flex justify-center gap-6 mt-10 max-h-[738px] overflow-hidden px-12 lg:px-56">
